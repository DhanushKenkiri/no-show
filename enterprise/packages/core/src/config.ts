 ...
 */
export const monadTestnetChain: Chain = defineChain({
  ...monadTestnet,
  blockExplorers: {
...
export const MONAD_TESTNET_X402 = "eip155:10143" as const;
 ...
 */
export const WRAPPED_MON: Address = "0xFb8bf4c1CC7a94c73D209a149eA2AbEa852BC541";
...
export const WMON_ASSET: AssetConfig = {
  address: WRAPPED_MON,
  symbol: "MON",
  decimals: 18,
  wrapsNative: true,
...
export const USDC_ASSET: AssetConfig = {
