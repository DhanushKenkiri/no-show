...
export declare const GAS: {
    ...
    readonly CREATE_EVENT: 70000n;
    /** Attendee-signed. */
    readonly REGISTER: 110000n;
    /**
     ...
     */
    readonly CHECK_IN: 90000n;
    /** Organiser-signed batches. Add PER_ADDRESS for each entry beyond the first. */
    readonly FINALIZE_BASE: 80000n;
    readonly PAYOUT_BASE: 70000n;
    readonly PER_ADDRESS: 30000n;
    /** Wrapping native token into its ERC-20 form. */
    readonly WRAP: 60000n;
    /** One-time Permit2 approval. */
    readonly APPROVE: 60000n;
};
/** Gas limit for a batch call over `count` addresses. */
export declare function batchGas(base: bigint, count: number): bigint;
