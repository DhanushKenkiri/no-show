 ...
 */
export declare const MONAD_TESTNET_RPC = "https://testnet-rpc.monad.xyz";
export declare const MONAD_TESTNET_WS = "wss://testnet-rpc.monad.xyz";
export declare const MONAD_TESTNET_EXPLORER = "https://testnet.monadvision.com";
/**
 ...
 */
export declare const monadTestnetChain: Chain;
/** x402 network identifier for Monad Testnet. */
export declare const MONAD_TESTNET_X402: "eip155:10143";
 ...
 */
export declare const WRAPPED_MON: Address;
export declare const MONAD_TESTNET_USDC: Address;
...
export type AssetConfig = {
    ...
    symbol: string;
    decimals: number;
    /** True when the asset is the chain's native token wrapped, so we can wrap for the user. */
    wrapsNative: boolean;
};
export declare const WMON_ASSET: AssetConfig;
export declare const USDC_ASSET: AssetConfig;
/**
 ...
 */
export declare const CHALLENGE_BLOCKS = 3n;
/**
 ...
 */
export declare const DEFAULT_VENUE_LEAD_WINDOWS = 1n;
/** Block tags map to Monad's commit states: Proposed, Voted, Finalized. */
export declare const COMMIT_STATES: readonly ["latest", "safe", "finalized"];
